          ...
          <div className="flex items-center space-x-3">
             ...
             <div>
                ...
                <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest leading-none">
                  {totalNotifications} tin nhắn chờ
                </p>
             </div>
          </div>
                    ...
                    <div key={req.userId} className="p-4 bg-slate-50/50 hover:bg-white border border-transparent hover:border-slate-100 rounded-2xl transition-all group shadow-sm hover:shadow-md">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="min-w-0 flex-1">
                          <p className="text-sm font-black text-slate-800 truncate">{req.fullName}</p>
                          <p className="text-[10px] font-bold text-slate-400 uppercase tracking-tighter">{req.phoneNumber}</p>
                        </div>
                      </div>
                      ...
                      <div className="mt-4 flex space-x-2">
                        <button 
                          ...
                          className="flex-1 py-2.5 bg-indigo-600 text-white text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-indigo-700 transition-all shadow-lg shadow-indigo-200"
                        >
                          Chấp nhận
                        </button>
                        <button 
